...
def home(request):
    ...
    # contains makes sure the value we pass in the request has a match in the topics name
    # icontains makes sure the search is not case sensitive
...
def room(request, pk):
    room = Room.objects.get(id=pk)  # get this by a unique value
